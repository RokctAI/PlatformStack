...
sudo chown -R root:root "$CALLERS_DIR"
sudo chmod -R 755 "$CALLERS_DIR"
_log "    StartupOS Callers successfully baked at $CALLERS_DIR (Root owned, read-only for frappe user)."
